  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[#ca4754]/20 text-[#f87171] rounded-lg hover:bg-[#ca4754]/30 transition-colors"
          >
            <LogOut size={16} />
            Sign out
          </button>
      ...
      <div className="bg-[#2d2d2d] rounded-xl p-6">
        ...
        {results.length === 0 ? (
          <p className="text-[#646669] text-center py-8">No tests completed yet. Start typing to see your results!</p>
        ) : (
